    ...
    <div className="min-h-screen">
      ...
      <main className="pt-16">
        <section className="relative py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          {/* Main Cards Grid - 2 Column Layout */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600/30 to-purple-600/30 flex items-center justify-center mr-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-700">
                    <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors duration-700">What We Do</h3>
                </div>
                <ul className="space-y-3 text-gray-300 text-sm mb-4 group-hover:text-gray-100 transition-colors duration-700">
                  <li className="flex items-start group/item">
                    <span className="text-blue-400 mr-2 mt-1 group-hover/item:scale-125 transition-transform duration-300">▸</span>
                ...
                <Link
                  href="/services"
                  className="inline-flex items-center text-blue-400 hover:text-blue-300 font-semibold transition-colors duration-300 group/link text-sm"
                >
                  Explore Services
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-600/30 to-pink-600/30 flex items-center justify-center mr-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-700">
                    <svg className="w-6 h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-white group-hover:text-purple-400 transition-colors duration-700">Our Approach</h3>
                </div>
                <ul className="space-y-3 text-gray-300 text-sm mb-4 group-hover:text-gray-100 transition-colors duration-700">
                  <li className="flex items-start group/item">
                    <span className="text-purple-400 mr-2 mt-1 group-hover/item:scale-125 transition-transform duration-300">▸</span>
                    <span>Client-focused partnerships</span>
                  </li>
                  <li className="flex items-start group/item">
                    <span className="text-purple-400 mr-2 mt-1 group-hover/item:scale-125 transition-transform duration-300">▸</span>
                ...
                <Link
                  href="/who-we-are"
                  className="inline-flex items-center text-purple-400 hover:text-purple-300 font-semibold transition-colors duration-300 group/link text-sm"
                >
                  Meet The Team
                  <svg className="w-4 h-4 ml-2 group-hover/link:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-600/30 to-red-600/30 flex items-center justify-center mr-3 group-hover:scale-110 group-hover:rotate-3 transition-all duration-700">
                    <svg className="w-6 h-6 text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-white group-hover:text-orange-400 transition-colors duration-700">Why Choose Us</h3>
                </div>
                ...
                <Link
                  href="/who-we-are"
                  className="inline-flex items-center text-orange-400 hover:text-orange-300 font-semibold transition-colors duration-300 group/link text-sm"
                >
                  Learn More
                  <svg className="w-4 h-4 ml-2 group-hover/link:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
